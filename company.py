...
class product:
        ...
        def __init__(self, root):
            ...
            #button
            self.b2 = Button(self.root,text="ADD", font=('bahnschrift', 15, 'bold'),bg="white" ,command=self.addCompany)
            self.b1 = Button(self.root,text="UPDATE", font=('bahnschrift', 15, 'bold'), bg="white",command=self.updateCompany)
            self.b3 = Button(self.root,text="DELETE", font=('bahnschrift', 15, 'bold'),bg="white" ,command=self.deleteCompany)
            self.b4 = Button(self.root,text="CLEAR", font=('bahnschrift', 15, 'bold'),bg="white",command=self.clearCompany)
            self.b5 = Button(self.root,text="BACK", font=('bahnschrift', 15, 'bold'),bg="white")
